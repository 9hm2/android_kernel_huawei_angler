...
"        }\n"
"        break;\n\n"
"        case 0x610: // 1552: FORCE-DECRYPT -- program a descriptor + WEP key (slot 0)\n"
"        {           //        for the foreign AP whose A2 is in arg[0..5], so its\n"
"            //        unprotected EAPOL is routed through WEP-decrypt (recover the\n"
"            //        body via host RC4 XOR-back). Suspends the MAC internally -- safe.\n"
"            extern void nexmon_forcedecrypt_program(struct wlc_info *wlc, const unsigned char *mac);\n"
"            if (len >= 6) {\n"
"                unsigned char mac[6]; int i;\n"
"                for (i = 0; i < 6; i++) mac[i] = (unsigned char) arg[i];\n"
"                nexmon_forcedecrypt_program(wlc, mac);\n"
"                ret = IOCTL_SUCCESS;\n"
"            }\n"
"        }\n"
"        break;\n\n"
"        case 0x611: // 1553: read the force-decrypt programming verify bitmask (LE16).\n"
"        {           //        0x1F = descriptor TA + keyidx/algo + key + nrrxtrans all\n"
"            //        read back correctly; 0xFFFF = 0x610 not yet run.\n"
"            extern unsigned short nexmon_fd_verify(void);\n"
"            unsigned short vfy = nexmon_fd_verify();\n"
"            if (len >= 2) {\n"
"                arg[0] = (char) (vfy & 0xff);\n"
"                arg[1] = (char) (vfy >> 8);\n"
"                ret = IOCTL_SUCCESS;\n"
...
"        }\n"
"        break;\n\n"
"        case 0x603: // 1539: DISABLED. This used to call 0x3085C as \"wlc_read_shm\",\n"
"        {           //        but 0x3085C is actually wlc_suspend_mac_and_wait(wlc) on\n"
"            //        bcm4358 7_112_300_14 -- calling it suspends the MAC without a\n"
"            //        matching enable and can wedge the dongle. Use cmd 0x604 (objmem\n"
"            //        sel 0x10000) for byte-precise SHM reads instead. No-op here.\n"
"            ret = IOCTL_ERROR;\n"
"        }\n"
"        break;\n\n"
)
