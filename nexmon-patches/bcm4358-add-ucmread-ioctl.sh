...
"        }\n"
"        break;\n\n"
"        case 0x604: // 1540: read d11 SHM via objmem select 0x10000 (same proven\n"
"        case 0x605: // 1541: path as cmd 0x600; 0x604 sel=0x10000, 0x605 sel=0x20000)\n"
"        {\n"
"            // arg in:  u32 byte_offset, u32 length; arg out: arg[i]=mem[off+i]\n"
"            if (len >= 8) {\n"
"                unsigned int off, n, i;\n"
"                int sel = (cmd == 0x604) ? 0x10000 : 0x20000;\n"
"                struct wlc_hw_info *wlc_hw = wlc->hw;\n"
"                memcpy(&off, arg + 0, 4);\n"
"                memcpy(&n,   arg + 4, 4);\n"
"                if (n > 256) n = 256;\n"
...
"        }\n"
"        break;\n\n"
"        case 0x606: // 1542: read the correlated SHM snapshot at the EAPOL moment\n"
"        {\n"
