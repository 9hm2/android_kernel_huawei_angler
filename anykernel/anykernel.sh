...
# Note: the udev hwdb.bin (lsusb name DB) is published as a separate release
# asset, NOT installed by this flasher. Install it by hand inside the Kali
# chroot with curl/wget -> /etc/udev/hwdb.bin (see chroot-extras/README.txt).
